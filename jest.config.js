...
module.exports = {
  ...
  // cacheDirectory: "/private/var/folders/8x/x2zqm30j0y155rlgqk2sdg300000gp/T/jest_dy",
  ...
  globalTeardown: './tests/global_teardown.ts',

  // A set of global variables that need to be available in all test environments
  // globals: {},

  // The maximum amount of workers used to run your tests. Can be specified
  // as % or a number. E.g. maxWorkers: 10% will use 10% of your CPU amount + 1
